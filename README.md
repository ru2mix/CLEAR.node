...
Если что для сервера есть апи документация 
http://127.0.0.1:8001/docs
Если вдруг кому нужно (Создается автоматически)
...
P.S. Если что то криво написали в nssm то так же пройдите в папку с ним и выполните nssm.exe edit <Имя службы>.

P.P.S. - Если на LINUX возникнет ошибка запуска скрипта, нужно выполнить: 
